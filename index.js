...
// Tu UID Real (Confirmado de la captura)
...
function performLogin() {
    ...
    // Normalizar usuario: ADMIN -> admin@gimnastik.com
    let email = u.toLowerCase();
    if (!email.includes('@')) email += '@gimnastik.com';

    // Contraseña se envía tal cual (ADMIN2025)
...
async function registerStudent() {
    ...
    const st = {
        ...
        createdBy: window.auth.currentUser.uid // Guardado con UID
    };
